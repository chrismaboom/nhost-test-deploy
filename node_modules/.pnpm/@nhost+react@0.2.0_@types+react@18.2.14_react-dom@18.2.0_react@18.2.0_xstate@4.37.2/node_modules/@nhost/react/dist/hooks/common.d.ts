...
export declare const useNhost: () => Nhost;
export declare const useNhostInterpreter: () => InterpreterFrom<NhostMachine>;
export declare const useNhostBackendUrl: () => string;
export declare const useAuthLoading: () => boolean;
export declare const useAuthenticated: () => boolean;
export declare const useAccessToken: () => string | null;
export declare const useSignOut: (stateAll?: boolean) => {
    signOut: (valueAll?: boolean | unknown) => import("xstate").State<import("@nhost/client").NhostContext, {
        type: "SESSION_UPDATE";
        data: {
