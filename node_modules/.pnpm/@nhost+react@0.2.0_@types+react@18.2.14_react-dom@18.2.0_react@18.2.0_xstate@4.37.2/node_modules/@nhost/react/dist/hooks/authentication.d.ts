...
export declare const useEmailPasswordSignIn: (stateEmail?: string | undefined, statePassword?: string | undefined) => {
    signIn: (valueEmail?: string | unknown, valuePassword?: string | unknown) => import("xstate").State<import("@nhost/client").NhostContext, {
        type: "SESSION_UPDATE";
        data: {
        ...
        email?: string | undefined;
        password?: string | undefined;
        options?: import("@nhost/client").SignUpOptions | undefined;
    } | {
...
export declare const useEmailPasswordlessSignIn: (stateEmail?: string | undefined, stateOptions?: PasswordlessOptions | undefined) => {
    signIn: (valueEmail?: string | unknown, valueOptions?: PasswordlessOptions | undefined) => import("xstate").State<import("@nhost/client").NhostContext, {
        type: "SESSION_UPDATE";
        data: {
            session: import("@nhost/client").NhostSession;
        };
...
export declare const useAnonymousSignIn: () => {
    signIn: () => import("xstate").State<import("@nhost/client").NhostContext, {
        type: "SESSION_UPDATE";
        data: {
            session: import("@nhost/client").NhostSession;
        };
...
export declare const useProviderLink: () => Record<Provider, string>;
