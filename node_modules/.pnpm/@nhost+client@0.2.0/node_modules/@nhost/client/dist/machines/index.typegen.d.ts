export interface Typegen0 {
    ...
    eventsCausingActions: {
        saveSession: 'SESSION_UPDATE' | 'done.invoke.autoSignIn' | 'done.invoke.authenticateUserWithPassword' | 'done.invoke.authenticateAnonymously' | 'done.invoke.registerUser' | 'done.invoke.refreshToken' | 'done.invoke.authenticateWithToken';
        persist: 'SESSION_UPDATE' | 'done.invoke.autoSignIn' | 'done.invoke.authenticateUserWithPassword' | 'done.invoke.authenticateAnonymously' | 'done.invoke.registerUser' | 'done.invoke.refreshToken' | 'done.invoke.authenticateWithToken';
        ...
        saveAuthenticationError: 'error.platform.signingOut' | 'error.platform.authenticatePasswordlessEmail' | 'error.platform.authenticateUserWithPassword' | 'error.platform.authenticateAnonymously' | 'error.platform.registerUser';
    ...
    eventsCausingDelays: {};
    matchesStates: 'authentication' | 'authentication.checkAutoSignIn' | 'authentication.starting' | 'authentication.signedOut' | 'authentication.signedOut.noErrors' | 'authentication.signedOut.success' | 'authentication.signedOut.needsVerification' | 'authentication.signedOut.failed' | 'authentication.signedOut.failed.server' | 'authentication.signedOut.failed.validation' | 'authentication.signedOut.failed.validation.password' | 'authentication.signedOut.failed.validation.email' | 'authentication.signedOut.signingOut' | 'authentication.authenticating' | 'authentication.authenticating.passwordlessEmail' | 'authentication.authenticating.password' | 'authentication.authenticating.token' | 'authentication.authenticating.anonymous' | 'authentication.registering' | 'authentication.signedIn' | 'authentication.signedIn.refreshTimer' | 'authentication.signedIn.refreshTimer.disabled' | 'authentication.signedIn.refreshTimer.stopped' | 'authentication.signedIn.refreshTimer.idle' | 'authentication.signedIn.refreshTimer.running' | 'authentication.signedIn.refreshTimer.running.pending' | 'authentication.signedIn.refreshTimer.running.refreshing' | 'token' | 'token.idle' | 'token.running' | {
        authentication?: 'checkAutoSignIn' | 'starting' | 'signedOut' | 'authenticating' | 'registering' | 'signedIn' | {
            signedOut?: 'noErrors' | 'success' | 'needsVerification' | 'failed' | 'signingOut' | {
            ...
            signedIn?: 'refreshTimer' | {
                refreshTimer?: 'disabled' | 'stopped' | 'idle' | 'running' | {
